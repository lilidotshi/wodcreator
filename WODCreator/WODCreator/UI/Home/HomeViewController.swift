...
//        let exercise1 = Exercise(name: "Front Squat", equipment: .barbell, musclesWorked: [.glutes, .quads])
//        let exercise2 = Exercise(name: "Back Squat", equipment: .barbell, musclesWorked: [.glutes, .quads])
//        let squat1 = Workout.Component(exercise: exercise1, repScheme: [50], weight: 95)
//        let squat2 = Workout.Component(exercise: exercise2, repScheme: [50], weight: 95)
